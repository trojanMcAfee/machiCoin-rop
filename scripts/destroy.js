...
async function destroy() {
    const contractAddress = '0x71C789E0957571eFed01fEE6E3eA11051786b9E9';
    ...
    const machiContract = new ethers.Contract(contractAddress, abi, signer);
    console.log(machiContract.address);

    machiContract.destroy();
    console.log('Contract successfully destroyed');
}
